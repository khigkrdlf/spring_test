...
<FORM name='frm' method='POST' action='./createProc'
	...
	onsubmit="return inputCheck(this)" style="width: 935px; ">
  <TABLE class="table table-bordered" style="width: 920px; height: 614px; ">
    <TR>
      <TH>사진</TH>
    ...
    <TR>
      <TH>주소</TH>
      <TD><input type="text" name="address1" size="40" id="sample6_address"
      		placeholder="주소"><br>
